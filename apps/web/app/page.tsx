...
export default function Home() {
  return <main>
    ...
    <section id="engineering" className="section section--engineering" aria-labelledby="engineering-title" > <div className="section-shell"> <SectionHeading eyebrow="02 / ENGINEERING" title="THINK. DESIGN. BUILD." /> <div className="engineering-lab" id="engineering-title"> <span className="skill skill-qml">QML</span> <span className="skill skill-python">Python</span> <span className="skill skill-java">Java</span> <span className="skill skill-linux">Linux</span> <span className="skill skill-selenium">Selenium</span> <div className="lab-core"> <span>SYSTEM</span> <b>→</b> <span>PROJECT</span> </div> <span className="skill skill-git">Git</span> <span className="skill skill-github">GitHub</span> </div> <p className="section-note"> Technology is most useful when it is connected to a real problem, a real system, or meaningful work. </p> </div> </section>
